    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="max-w-md w-full relative z-10">
                {/* Signin Card */}
                <div className="bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-2xl border border-white/20 transform transition-all duration-500 hover:shadow-3xl">
                    {/* Back Button */}
                    ...
                    <div className="text-center mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 transform transition-all duration-500 hover:scale-110 hover:rotate-12 shadow-lg">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="transform transition-all duration-300">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 rounded-xl border-2 border-gray-200 focus:border-purple-600 focus:outline-none transition-all duration-300 bg-white/50 backdrop-blur-sm hover:bg-white"
                        ...
                        <div className="transform transition-all duration-300">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    onBlur={() => setFocusedField(null)}
                                    className="w-full pl-10 pr-12 py-2 rounded-xl border-2 border-gray-200 focus:border-purple-600 focus:outline-none transition-all duration-300 bg-white/50 backdrop-blur-sm hover:bg-white"
                        ...
                        <div className="transform transition-all duration-300">
                            ...
                            <select
                                ...
                                onBlur={() => setFocusedField(null)}
                                className={`w-full px-4 py-2 rounded-xl border-2 transition-all duration-300 bg-white/50 backdrop-blur-sm hover:bg-white ${focusedField === 'role' ? 'border-purple-600' : 'border-gray-200'
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-xl font-bold text-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed relative overflow-hidden group"
                        >
