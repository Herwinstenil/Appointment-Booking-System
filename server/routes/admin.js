...
router.get('/profile', authenticateToken, authorizeRoles('ADMIN'), async (req, res) => {
  try {
    ...
    const profileData = {
      ...
      email: admin.email || '',
      phone: admin.mobile ? (admin.mobile.startsWith('+91') ? admin.mobile : `+91 ${admin.mobile}`) : '',
...
router.put('/profile', authenticateToken, authorizeRoles('ADMIN'), [
  ...
  try {
    ...
    const profileData = {
      ...
      phone: updatedAdmin.mobile ? (updatedAdmin.mobile.startsWith('+91') ? updatedAdmin.mobile : `+91 ${updatedAdmin.mobile}`) : '',
